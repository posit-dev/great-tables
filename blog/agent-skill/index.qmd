...
The skill lives at `skills/great-tables/` in this repository. Point your agent's
skill installer at it, or just copy the folder into your own project. Read
`references/REFERENCE.md` first; it's the one file that tells you where everything
else in the skill lives.
