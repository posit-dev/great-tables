...
>
> <div id="dcc2d977" class="cell" execution_count="4">
>
> ``` python
...
>
> <div id="11f5b2fb" class="cell" execution_count="5">
>
> ``` python
...
>
> <div id="lbujccyymf" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
>
> | name | lines | case1 |
> |----|----|----|
...
>
> <div id="abfaa995" class="cell" execution_count="6">
>
> ``` python
...
>
> <div id="576bca20" class="cell" execution_count="7">
>
> Show the Code
>
> ``` python
...
>
> <div id="60e83784" class="cell" execution_count="8">
>
> ``` python
...
>
> <div id="mddnyvrjxs" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
>
> | name | lines | case2 |
> |----|----|----|
...
>
> <div id="053152e9" class="cell" execution_count="9">
>
> Show the Code
>
> ``` python
...
>
> <div id="dd1c6a8f" class="cell" execution_count="10">
>
> ``` python
...
>
> <div id="kradzkkinx" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
>
> | name | lines | case3 |
> |----|----|----|
> | Argentine | 1 | <span style="white-space:nowrap;"><img src="https://raw.githubusercontent.com/posit-dev/great-tables/refs/heads/main/great_tables/data/metro_images/metro_1.svg" style="height: 2em;vertical-align: middle;" /></span> |
...
>
> <div id="d327a286" class="cell" execution_count="11">
>
> Show the Code
>
> ``` python
...
>
> <div id="cc0bc1cd" class="cell" execution_count="12">
>
> ``` python
...
>
> <div id="bedf7eea" class="cell" execution_count="13">
>
> ``` python
> # equivalent to `Case 1`
> (
...
>
> <div id="uwginancvw" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
>
> | name | lines | case4 |
> |----|----|----|
> | Argentine | 1 | <span style="white-space:nowrap;"><img src="https://raw.githubusercontent.com/posit-dev/great-tables/refs/heads/main/great_tables/data/metro_images/metro_1.svg" style="height: 2em;vertical-align: middle;" /></span> |
...
> >
> > <div id="9accac83" class="cell" execution_count="14">
> >
> > ``` python
...
> >
> > <div id="onavntqkgg" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
> >
> > | name | lines | case4 |
> > |----|----|----|
> > | Argentine | 1 | <span style="white-space:nowrap;"><img src="data:image/svg+xml;base64," style="height: 2em;vertical-align: middle;" /></span> |
...
> >
> > <div id="f2d21feb" class="cell" execution_count="15">
> >
> > Show the Code
> >
> > ``` python
...
> >
> > <div id="924d41ca" class="cell" execution_count="16">
> >
> > ``` python
...
> >
> > <div id="jdsqoxwrbb" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
> >
...
> >
> > <div id="1b1b7a6b" class="cell" execution_count="17">
> >
> > ``` python
...
> >
> > <div id="gjgylicvab" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
> >
> > <table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
> > <thead>
> > <tr class="gt_heading">
...
> >
> > <div id="58a663cc" class="cell" execution_count="18">
> >
> > ``` python
> > (
> >     GT(metro_mini)
