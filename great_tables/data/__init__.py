...
class _Dataset:
    ...
    @staticmethod
    def _convert_to_polars(v: Any) -> Any:
        import polars as pl
...
countrypops = Dataset.countrypops.to_pandas()
sza = Dataset.sza.to_pandas()
gtcars = Dataset.gtcars.to_pandas()
sp500 = Dataset.sp500.to_pandas()
pizzaplace = Dataset.pizzaplace.to_pandas()
exibble = Dataset.exibble.to_pandas()
towny = Dataset.towny.to_pandas()
peeps = Dataset.peeps.to_pandas()
films = Dataset.films.to_pandas()
metro = Dataset.metro.to_pandas()
gibraltar = Dataset.gibraltar.to_pandas()
constants = Dataset.constants.to_pandas()
illness = Dataset.illness.to_pandas()
reactions = Dataset.reactions.to_pandas()
photolysis = Dataset.photolysis.to_pandas()
nuclides = Dataset.nuclides.to_pandas()
