    ...
    units_tbl = pl.DataFrame(
        {
            "rule": [
                ...
                "transformation of common units from ASCII to preferred form - 1",
                "transformation of common units from ASCII to preferred form - 2",
                "transformation of common units from ASCII to preferred form - 3",
                "insertion of common symbols and Greek letters via `:[symbol name]:` - 1",
                "insertion of common symbols and Greek letters via `:[symbol name]:` - 2",
                "insertion of common symbols and Greek letters via `:[symbol name]:` - 3",
