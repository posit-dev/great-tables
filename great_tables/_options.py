...
class OptionsAPI:
    def tab_options(
        ...
        container_overflow_x, container_overflow_y : bool
         ...
         table_font_style
            The font style for the table. Can be one of either `"normal"`, `"italic"`, or
            `"oblique"`.
         ...
         row_group_default_label
            ...
            already exist), those rows will be automatically placed into a row group without a
            label.
