...
class LocSourceNotes(Loc):
    ...
    The `loc.source_notes()` class is used to target the source notes in the table. The class can be
    used to apply custom styling with the [`tab_style()`](`great_tables.GT.tab_style`) method. That
    method has a `locations=` argument and this class should be used there to perform the targeting.
    The 'source_notes' location is generated by
