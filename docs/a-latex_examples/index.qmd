...
power_cie_prepared_tbl = pd.read_csv("docs/examples/_data/power_cie_prepared_tbl.csv")
...
coffee_sales = pl.DataFrame.deserialize("docs/examples/_data/coffee-sales.json", format="json")
