...
<p style="font-size: 12px;">Drawing of clay tablet from Sumerian city of Uruk, circa 3200-3000 BCE. Uruk III Tablet (MSVO 3, 51, Louvre Museum, Paris, France).</p>
...
While there were knowledgeable practictioners who could well perform the task of typesetting tables in books, there wasn't much in the way of books about tabular presentation and all the attendant theoretical and practical approaches one might take. To remedy this (but more likely to serve as an internal tool for the organization), the United States Bureau of the Census published their *Manual of Tabular Presentation*[^9]. It is truly a remarkable work and one can readily plumb the considerable depths of this monograph for its excellent recommendations on tabular design. It spares no detail on how the department classifies the different parts of a table, describing the function of each part in rigorous detail. Moreover, it is easy to read and thankfully provides many examples in visual form. Through its many hundreds of paragraphs, the authors make strong recommendations on what to do (and what *not* to do) for many tabulation scenarios.
