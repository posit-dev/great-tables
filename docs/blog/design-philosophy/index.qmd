...
* a header and a footer for explanatory text
* a stub for identification of the rows and any hierarchical arrangements therein
* spanner labels over top of the column labels
...
Here's a table that takes advantage of the different components available in **Great Tables**.
