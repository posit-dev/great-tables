...
The optional dependency simply allow users of one DataFrame library to not have to install the others.
...
We also still rely on pandas for datasets in `great_tables.data`, but will remove it soon (see [this issue](https://github.com/posit-dev/great-tables/issues/91)).
