...
The [PR to implement `.style` in Polars](https://github.com/pola-rs/polars/pull/16809) went super quick, from advice on discord April to merged by June. In this section I'll look at how we addressed the 3 big requirements behind making a strong case for `.DataFrame.style` returning a Great Tables object:
...
table design and tooling. For example, Rich's version of Great Tables in R, called `gt`, has been around since 2019 (see his rstudio::conf() talk).
