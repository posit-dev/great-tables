...
Having a reference line and/or area can be valuable in different situations. We make it easy by allowing literal values or keywords (these are: `"mean"`, `"median"`, `"min"`, `"max"`, `"q1"`, `"q3"`, `"first"`, or `"last"`).
