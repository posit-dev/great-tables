...
- quick spanner creation with the new `GT.tab_spanner_delim()` method
- easy boolean value formatting with the new `GT.fmt_tf()` method
- column label rotation via `GT.cols_label_rotate()`
- custom datetime formatting through the enhanced `GT.fmt_datetime()` method
