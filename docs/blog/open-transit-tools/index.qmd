---
title: Contributing to Public Transit Data Analyses and Tooling
---
...
People doing analytics in public transit are active in developing open standards (like GTFS, GTFS-RT, and TIDES). These open data sources are complex---they cover schedules that change from week to week, busses moving in realtime, and passenger events. As people like me work more and more on open source tools, we start to lose touch with data analysis in realistic, complex settings. Working on open source transit data is an opportunity for me to ensure my open source tooling work helps people solve real, complex problems.
...
Here is a link to to [the interactive table by Josh Fangmeier](https://joshfangmeier.quarto.pub/table-contest-2022/#sec-table). And I'll drop a handy screenshot below.
...
* **Workshops on Python**. Let's say Polars, Quarto, publishing notebooks, Great Tables, warehouse stuff.
...
Analytics in public transit is a really neat, impactful area---with an active community working on open source data standards and tooling. As a data science tool builder on the open source team at Posit, PBC, my mission is to create value and give it away to teams doing code first data science.
