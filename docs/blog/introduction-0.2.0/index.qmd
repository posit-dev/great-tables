...
This was just a sampler of what you can do with the all-new `data_color()` method. Take a look at the [*Colorizing with Data*](/get-started/colorizing-with-data.qmd) page in the *Get Started* Guide. It provides more details on how to use `data_color()` (many more than we can show you in this blog post).
