...
This table will serve as a great starting point for demonstrating all the things you can now do with `tab_style()`.

The following checklist will serve as a rough plan for how we will style the table:
