---
title: "Great Tables: Dreamy DataFrame Styling for Polars"
...
As it turns out, polars expressions make styling tables very straightforward. The same polars code that you would to select or filter combines with Great Tables to highlight, circle, or bolden text.
