...
# Filter `sp500` between `start_date` and `end_date`
sp500_mini = sp500[(sp500["date"] >= start_date) & (sp500["date"] <= end_date)].drop(
    columns="adj_close"
)

# Create a table based on a subset of the `sp500` table data
(
    GT(data=sp500_mini)
