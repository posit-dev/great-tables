...
## Specifying column selection

In the above examples, we selected columns to span or move using a list of column names (as strings).
However, **great_tables** supports a wide range of ways to select columns.
