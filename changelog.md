...
- [<span class="citation" data-cites="KristijanArmeni">@KristijanArmeni</span>](https://github.com/KristijanArmeni) made their first contribution in https://github.com/posit-dev/great-tables/pull/794
- [<span class="citation" data-cites="mrapacz">@mrapacz</span>](https://github.com/mrapacz) made their first contribution in https://github.com/posit-dev/great-tables/pull/823
- [<span class="citation" data-cites="minimav">@minimav</span>](https://github.com/minimav) made their first contribution in https://github.com/posit-dev/great-tables/pull/404
- [<span class="citation" data-cites="jiboncom">@jiboncom</span>](https://github.com/jiboncom) made their first contribution in https://github.com/posit-dev/great-tables/pull/803
...
- [<span class="citation" data-cites="kianmeng">@kianmeng</span>](https://github.com/kianmeng) made their first contribution in https://github.com/posit-dev/great-tables/pull/798
- [<span class="citation" data-cites="thriller08">@thriller08</span>](https://github.com/thriller08) made their first contribution in https://github.com/posit-dev/great-tables/pull/802
- [<span class="citation" data-cites="schmidma">@schmidma</span>](https://github.com/schmidma) made their first contribution in https://github.com/posit-dev/great-tables/pull/770
- [<span class="citation" data-cites="lorenzo-w">@lorenzo-w</span>](https://github.com/lorenzo-w) made their first contribution in https://github.com/posit-dev/great-tables/pull/792
...
- NumPy has been removed as a dependency; all NumPy usage replaced with standard Python. ([\#749](https://github.com/posit-dev/great-tables/issues/749), [<span class="citation" data-cites="tylerriccio33">@tylerriccio33</span>](https://github.com/tylerriccio33))
- `row_group_as_column=True` now correctly structures row groups as a column in the stub (previously a no-op). ([\#754](https://github.com/posit-dev/great-tables/issues/754), [<span class="citation" data-cites="juleswg23">@juleswg23</span>](https://github.com/juleswg23))
- PyArrow `float64` columns are now right-aligned by default, matching Pandas and Polars behavior. ([\#734](https://github.com/posit-dev/great-tables/issues/734), [<span class="citation" data-cites="FBruzzesi">@FBruzzesi</span>](https://github.com/FBruzzesi))
...
- Corrected various typos. ([\#730](https://github.com/posit-dev/great-tables/issues/730), [<span class="citation" data-cites="FBruzzesi">@FBruzzesi</span>](https://github.com/FBruzzesi))
- Added a Posit badge to the project website header. ([\#777](https://github.com/posit-dev/great-tables/issues/777))


### Internal

- Refactored code for better adherence to best practices and improved performance. ([\#731](https://github.com/posit-dev/great-tables/issues/731), [<span class="citation" data-cites="FBruzzesi">@FBruzzesi</span>](https://github.com/FBruzzesi))


### New Contributors

- [<span class="citation" data-cites="FBruzzesi">@FBruzzesi</span>](https://github.com/FBruzzesi) made their first contribution in https://github.com/posit-dev/great-tables/pull/731
...
- [<span class="citation" data-cites="dpprdan">@dpprdan</span>](https://github.com/dpprdan) made their first contribution in https://github.com/posit-dev/great-tables/pull/670
- [<span class="citation" data-cites="juleswg23">@juleswg23</span>](https://github.com/juleswg23) made their first contribution in https://github.com/posit-dev/great-tables/pull/696
- [<span class="citation" data-cites="ChristopherRussell">@ChristopherRussell</span>](https://github.com/ChristopherRussell) made their first contribution in https://github.com/posit-dev/great-tables/pull/695
- [<span class="citation" data-cites="mahdibaghbanzadeh">@mahdibaghbanzadeh</span>](https://github.com/mahdibaghbanzadeh) made their first contribution in https://github.com/posit-dev/great-tables/pull/673
...
- HTML ID attributes are now unique per table, which may affect code that relied on the previous static ID. ([\#607](https://github.com/posit-dev/great-tables/issues/607), [<span class="citation" data-cites="BenGale93">@BenGale93</span>](https://github.com/BenGale93))
...
- Resolved an encoding issue in `GT.save()`. ([\#609](https://github.com/posit-dev/great-tables/issues/609), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
- Non-integer values are now correctly passed to nanoplot options. ([\#608](https://github.com/posit-dev/great-tables/issues/608), [<span class="citation" data-cites="tylerriccio33">@tylerriccio33</span>](https://github.com/tylerriccio33))
...
- [<span class="citation" data-cites="tylerriccio33">@tylerriccio33</span>](https://github.com/tylerriccio33) made their first contribution in https://github.com/posit-dev/great-tables/pull/608
- [<span class="citation" data-cites="BenGale93">@BenGale93</span>](https://github.com/BenGale93) made their first contribution in https://github.com/posit-dev/great-tables/pull/607
- [<span class="citation" data-cites="zachvalenta">@zachvalenta</span>](https://github.com/zachvalenta) made their first contribution in https://github.com/posit-dev/great-tables/pull/627
...
- [<span class="citation" data-cites="stinodego">@stinodego</span>](https://github.com/stinodego) made their first contribution in https://github.com/posit-dev/great-tables/pull/563
...
- Improved detection of Polars installation. ([\#505](https://github.com/posit-dev/great-tables/issues/505), [<span class="citation" data-cites="lukemanley">@lukemanley</span>](https://github.com/lukemanley))
- Fixed missing exception raise in `_val_is_numeric()` and `_val_is_str()`. ([\#510](https://github.com/posit-dev/great-tables/issues/510), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
...
- Switched to ruff for linting and formatting, and fixed `mypy` errors. ([\#511](https://github.com/posit-dev/great-tables/issues/511), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
- Standardized imports by converting to relative imports. ([\#521](https://github.com/posit-dev/great-tables/issues/521), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
- Added CI build for Python 3.13. ([\#514](https://github.com/posit-dev/great-tables/issues/514), [<span class="citation" data-cites="glemaitre">@glemaitre</span>](https://github.com/glemaitre))
...
- [<span class="citation" data-cites="lukemanley">@lukemanley</span>](https://github.com/lukemanley) made their first contribution in https://github.com/posit-dev/great-tables/pull/505
- [<span class="citation" data-cites="glemaitre">@glemaitre</span>](https://github.com/glemaitre) made their first contribution in https://github.com/posit-dev/great-tables/pull/514
- [<span class="citation" data-cites="amol">@amol</span>](https://github.com/amol)- made their first contribution in https://github.com/posit-dev/great-tables/pull/487
...
- Added preview sections for built-in datasets. ([\#453](https://github.com/posit-dev/great-tables/issues/453), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
...
- Global `locale` is now respected in all `fmt_*()` methods. ([\#473](https://github.com/posit-dev/great-tables/issues/473), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
...
- Updated the Super Bowl example to align with the latest version of Polars. ([\#460](https://github.com/posit-dev/great-tables/issues/460), [\#462](https://github.com/posit-dev/great-tables/issues/462), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
...
- Standardize on the `GTSelf` object in method signatures by [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw) in https://github.com/posit-dev/great-tables/pull/431
- Consistently use `isinstance()` checks throughout the codebase instead of checking with `hasattr()` by [<span class="citation" data-cites="rich-iannone">@rich-iannone</span>](https://github.com/rich-iannone) in https://github.com/posit-dev/great-tables/pull/434
- Improve test coverage for various `opt_*` methods by [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw) in https://github.com/posit-dev/great-tables/pull/437
- Consolidate ordered list code using the new `_create_ordered_list()` function by [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw) in https://github.com/posit-dev/great-tables/pull/407
- Internally use `OrderedSet().as_list()` instead of `list(OrderedSet())` for sake of clarity by [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw) in https://github.com/posit-dev/great-tables/pull/447
- Refactor import statements throughout the `_formats.py` file by [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw) in https://github.com/posit-dev/great-tables/pull/450
...
- Mentioned Polars support in the *Get Started* section. ([\#408](https://github.com/posit-dev/great-tables/issues/408), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
- Fixed typos and improved a code example in the "Design Philosophy" doc. ([\#401](https://github.com/posit-dev/great-tables/issues/401), [<span class="citation" data-cites="alfredocarella">@alfredocarella</span>](https://github.com/alfredocarella))
- Fixed a typo in a blog post. ([\#396](https://github.com/posit-dev/great-tables/issues/396))
- Updated documentation for datasets. ([\#397](https://github.com/posit-dev/great-tables/issues/397), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
- Updated Polars examples for a deprecated argument. ([\#400](https://github.com/posit-dev/great-tables/issues/400), [<span class="citation" data-cites="atseewal">@atseewal</span>](https://github.com/atseewal))
- Removed mentions of `accounting` in `force_sign=` argument docs. ([\#422](https://github.com/posit-dev/great-tables/issues/422))


### New Contributors

- [<span class="citation" data-cites="alfredocarella">@alfredocarella</span>](https://github.com/alfredocarella) made their first contribution in https://github.com/posit-dev/great-tables/pull/401
...
- [<span class="citation" data-cites="isabelizimm">@isabelizimm</span>](https://github.com/isabelizimm) made their first contribution in https://github.com/posit-dev/great-tables/pull/377
- [<span class="citation" data-cites="lostmygithubaccount">@lostmygithubaccount</span>](https://github.com/lostmygithubaccount) made their first contribution in https://github.com/posit-dev/great-tables/pull/388
...
- Added an RSS feed to the blog. ([\#367](https://github.com/posit-dev/great-tables/issues/367), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))


### Internal

- Refactored `seq_groups()` to accept `Iterable`. ([\#365](https://github.com/posit-dev/great-tables/issues/365), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
- Moved `pairwise()`, `seq_groups()`, and `is_equal()` to `_utils.py`. ([\#369](https://github.com/posit-dev/great-tables/issues/369), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
...
- Fixed column selections breaking with Polars v0.20.28. ([\#360](https://github.com/posit-dev/great-tables/issues/360), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
- Fixed `_save_screenshot()` failing for non-PNG file formats. ([\#352](https://github.com/posit-dev/great-tables/issues/352), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))


### Internal

- Enhanced test coverage. ([\#339](https://github.com/posit-dev/great-tables/issues/339), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
...
- **Multi-level spanners** -- Column spanners can now be nested under other spanners to create hierarchical column groupings. ([\#345](https://github.com/posit-dev/great-tables/issues/345), [<span class="citation" data-cites="timkpaine">@timkpaine</span>](https://github.com/timkpaine))
...
- Cleaned up minor formatting issues in the docs. ([\#338](https://github.com/posit-dev/great-tables/issues/338), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))


### New Contributors

- [<span class="citation" data-cites="timkpaine">@timkpaine</span>](https://github.com/timkpaine) made their first contribution in https://github.com/posit-dev/great-tables/pull/345
...
- Added examples to API reference pages. ([\#328](https://github.com/posit-dev/great-tables/issues/328), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))


### Internal

- Removed unused `webcolors` library as a required dependency. ([\#336](https://github.com/posit-dev/great-tables/issues/336), [<span class="citation" data-cites="marcozzxx810">@marcozzxx810</span>](https://github.com/marcozzxx810))


### New Contributors

- [<span class="citation" data-cites="marcozzxx810">@marcozzxx810</span>](https://github.com/marcozzxx810) made their first contribution in https://github.com/posit-dev/great-tables/pull/336
...
Great Tables `v0.5.1` is a maintenance release focused on bug fixes, code quality improvements, and documentation. Special thanks to [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw) for an incredible number of contributions.
...
- Fixed typos throughout the docs. ([\#286](https://github.com/posit-dev/great-tables/issues/286), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))
- Added a community example from [<span class="citation" data-cites="chalg">@chalg</span>](https://github.com/chalg). ([\#323](https://github.com/posit-dev/great-tables/issues/323))
...
- Added `py.typed` marker to support PEP 561 type-checking. ([\#139](https://github.com/posit-dev/great-tables/issues/139), [<span class="citation" data-cites="sugatoray">@sugatoray</span>](https://github.com/sugatoray))
...
- Fixed a column name in the *Column Labels* documentation. ([\#187](https://github.com/posit-dev/great-tables/issues/187), [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw))


### New Contributors

- [<span class="citation" data-cites="sugatoray">@sugatoray</span>](https://github.com/sugatoray) made their first contribution in https://github.com/posit-dev/great-tables/pull/139
- [<span class="citation" data-cites="jrycw">@jrycw</span>](https://github.com/jrycw) made their first contribution in https://github.com/posit-dev/great-tables/pull/189
...
- Fixed tab spanner column name resolution. ([\#111](https://github.com/posit-dev/great-tables/issues/111), [<span class="citation" data-cites="atseewal">@atseewal</span>](https://github.com/atseewal))
...
- [<span class="citation" data-cites="atseewal">@atseewal</span>](https://github.com/atseewal) made their first contribution in https://github.com/posit-dev/great-tables/pull/111
...
- Added hyperlinks in a table example. ([\#70](https://github.com/posit-dev/great-tables/issues/70), [<span class="citation" data-cites="kmasiello">@kmasiello</span>](https://github.com/kmasiello))
...
- [<span class="citation" data-cites="kmasiello">@kmasiello</span>](https://github.com/kmasiello) made their first contribution in https://github.com/posit-dev/great-tables/pull/70
