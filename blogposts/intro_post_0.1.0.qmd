...
The [documentation site](https://posit-dev.github.io/great-tables/) was built using `quartodoc`. It's designed to look easy on the eyes while also providing a ton of useful information.

Check out these handy sections of the docs to learn more:
...
## We Are on the Path Toward Table Success

While we’re only getting started on this package we absolutely feel things are really coming along! We want to hear from you and get your feedback on the package. There are quite a few ways to do this, so here are all the options:
