...
We support hundreds of locales, from `af` to `zu`! While there are more formatting methods yet to be added, the ones that are available now do work exceedingly well.
